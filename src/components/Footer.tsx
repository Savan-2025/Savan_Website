      ...
      <div className="max-w-[1440px] mx-auto px-6 grid md:grid-cols-3 gap-12">
        ...
        <div>
          ...
          <div className="flex gap-4 text-lg">
            <a href="https://www.instagram.com/saajrarealty?igsh=MWplaTA3MWJ0ZHN1Yg==" aria-label="Instagram" className="hover:text-sky-400"><FaInstagram /></a>
            <a href="https://www.facebook.com/share/1F4RnTkWKH/?mibextid=wwXIfr" aria-label="Facebook" className="hover:text-sky-400"><FaFacebookF /></a>
        ...
        <div>
          ...
          <p className="flex items-center mb-2"><Phone className="h-4 w-4 mr-2" /> Phone: 9924555520</p>
